                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="m-t-30" action="{{route('storeExperience')}}" method="post" id="add_experience">
                                    @csrf
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea rows="5" class="form-control form-control-line" name="body" id="body"></textarea>
                                    </div>

                                    <button type="submit" class="btn btn-primary">Insert Experience</button>
                                </form>
                            </div>
                        </div>
                    </div>
