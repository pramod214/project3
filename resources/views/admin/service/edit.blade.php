                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="m-t-30" action="{{route('service.update',$service->id)}}" method="post" id="add_service">
                                    @csrf
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="type" class="form-control" id="icon" name="icon" value="{{$service->icon}}">
                                    </div>

                                    <div class="form-group">
                                        <label for="body">Content</label>
                                        <textarea rows="5" class="form-control form-control-line" name="body" > {{$service->body}}</textarea>
                                    </div>
