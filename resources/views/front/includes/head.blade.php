<head>
    ...
    <link rel="stylesheet" href="{{asset('public/frontend/css/responsive-style.css')}}">

    <!-- ==== Color Scheme Stylesheet ==== -->
    <link rel="stylesheet" href="{{asset('public/frontend/css/colors/color-1.css')}}" id="changeColorScheme">
